...
1. [Download the latest Release](https://github.com/KawaneRio/vrchat_world.py/releases/download/v1.0.0/IjustWannaKnowHowtheVRChatAPIworks_AlsoPleaseHireMeVRChat_PythonScript_by_KawaneRio.py)
...
6. [Download the latest Release](https://github.com/KawaneRio/vrchat_world.py/releases/download/v1.0.0/IjustWannaKnowHowtheVRChatAPIworks_AlsoPleaseHireMeVRChat_PythonScript_by_KawaneRio.py)
